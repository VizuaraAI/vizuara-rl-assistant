    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8" style={{ backgroundColor: '#fbfbfd' }}>
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-lg mb-12 max-w-md mx-auto" style={{ color: '#86868b' }}>
          Your personal AI teaching assistant for the Reinforcement Learning Research Bootcamp
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-sm" style={{ color: '#86868b' }}>
              Access your inbox, send messages to Dr. Rajat, and track your learning journey
            </p>
          </Link>
